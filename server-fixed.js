...
// Prüfe ob dist existiert, sonst nutze Vite Dev Server
...
if (distExists) {
  ...
  console.log('⚠️  No dist folder found, starting Vite dev server...');
  // Importiere Vite dynamisch
...
// Fallback für SPA nur wenn dist existiert
if (distExists) {
  app.get('*', (req, res) => {
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`   Mode: ${distExists ? 'PRODUCTION' : 'DEVELOPMENT (Vite)'}`);
});
